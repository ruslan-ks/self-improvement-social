...
(
    ...
    avatar_file_name text UNIQUE          DEFAULT NULL,
...
(
    ...
    FOREIGN KEY (user_id, activity_id) REFERENCES user_activities (user_id, activity_id)
);
...
INSERT INTO user_activities_completions(user_id, activity_id)
VALUES (1, 1),
       (1, 1),
       (1, 2);
