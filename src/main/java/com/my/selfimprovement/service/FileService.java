...
public interface FileService {
     ...
     * @throws com.my.selfimprovement.util.exception.IllegalMediaTypeException if {@code file} has not allowed media
     ...
     * @throws com.my.selfimprovement.util.exception.FileException if file cannot be saved
     ...
     * @throws com.my.selfimprovement.util.exception.FileException if file cannot be removed
     * (for example if IOException occurs)
     */
    @PreAuthorize("isAuthenticated()")
     ...
     * @throws com.my.selfimprovement.util.exception.FileException if file cannot be loaded
